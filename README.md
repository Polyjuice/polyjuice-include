...
- Host composition - composition found in the host HTML view (content of `<starcounter-include ...><template is="declarative-shadow-dom" mode="host">`). It's used to enforce by host view a given composition for any kind of elements.
